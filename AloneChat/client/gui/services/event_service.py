...
class APIClient:
    ...
    async def register(self, username: str, password: str) -> Dict[str, Any]:
        """Register a new user."""
        return await self._request("POST", "/api/auth/register", {
            "username": username,
            "password": password
        })
    ...
    async def send_message(
        ...
        return await self._request("POST", "/api/chat/send", {
    ...
    async def get_pending_messages(self) -> Dict[str, Any]:
        """Poll queued messages (replaces old /api/chat/pending)."""
        return await self._request("POST", "/api/chat/recv")

    async def clear_pending_messages(self) -> Dict[str, Any]:
        """Clear queued messages."""
        return await self._request("POST", "/api/chat/recv/clear")
