...
from AloneChat.client.client_base import Client
from AloneChat.client.utils import DEFAULT_HOST, DEFAULT_API_PORT
...
from AloneChat.client.api_client import APIClient
from AloneChat.message.protocol import MessageType
from .services.event_service import EventService, EventServiceConfig, ChatMessage
...
class GUIClient(Client):
    ...
    def __init__(self, api_host: str = DEFAULT_HOST, api_port: int = DEFAULT_API_PORT):
        ...
        self._api_client = APIClient(host=api_host, port=api_port)
