...
class CursesClient(Client):
        ...
        while True:
            try:
                ...
                match key:
                    ...
                    case curses.KEY_BACKSPACE | curses.KEY_DC | 8 | 127:  # Backspace key
                        # Remove the last character from input buffer if any
                        if self.input_buffer:
                    ...
                    case curses.KEY_HOME:  # Home key
                        self.scroll_offset = 0
                        self.auto_scroll = False

                    case curses.KEY_END:  # End key
                        self.auto_scroll = True
    ...
    async def _go_away(self):
        """
        Graceful logout via HTTP API.
        """
